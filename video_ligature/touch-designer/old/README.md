...
J'ai réalisé en amont une série d'opérateur qui décomposent chromatiquement ma vidéo source. Pour que cette vidéo ai l'aspect de formes géométriques/organiques mouvantes. j'ai éxtrait des informations via info1 que j'ai passé en Viewer Active, j'ai ensuite drag and drop info1 > resx > grid1 > grid > size > + > sizex, j'ai répété cette manipulation avec info1 > resy > grid1 > grid > size > + > sizey. Puis ai divisé par 40 (/40) pour que les particules s'étendent ensuite via le noise2. Afin que ces formes soient completement liés aux changements chromatiques de ma vidéo source, j'ai également drag and drop info1 > resx > grid1 > grid > rows > + > (cmdc/cmdv) op('info1')['resx'] mais aussi info1 > resy > grid1 > grid > columns > + > (cmdc/cmdv) op('info1')['resy']
